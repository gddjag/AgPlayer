...
{
    value = enumOrDefault(value, Auto, High, Auto);
...
void PlayerExperienceController::load()
{
    ...
    const int storedQuality = integer(QStringLiteral("qualityPreset"), Auto);
    qualityPreset_ = storedQuality == 4
        ? High : enumOrDefault(storedQuality, Auto, High, Auto);
