...
Assert-Match $shell 'property int waveformHeight:\s*Qt\.platform\.os === "osx"\s*\?\s*100\s*:\s*96' 'Integrated waveform must be 100px on macOS and 96px on other platforms.'
