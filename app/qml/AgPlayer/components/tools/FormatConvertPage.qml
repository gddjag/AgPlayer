...
Rectangle {
    ...
    Component {
        ...
        FileDialog {
            ...
            nameFilters: [qsTr("音频与视频文件 (*.wav *.mp3 *.flac *.aac *.m4a *.ogg *.opus *.aif *.aiff *.mp4 *.mkv *.avi *.mov *.webm *.ncm *.kgm *.kgma *.vpr *.kwm *.qmc0 *.qmc2 *.qmc3 *.qmc4 *.qmc6 *.qmc8 *.qmcflac *.qmcogg *.mflac *.mflac0 *.mgg *.mgg0 *.mgg1 *.mggl *.tkm *.bkcmp3 *.bkcm4a *.bkcflac *.bkcwav *.bkcape *.bkcogg *.bkcwma)")]
            onAccepted: {
