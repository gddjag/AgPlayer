...
Rectangle {
    ...
    readonly property color sourcePreviewAccent: "#FFB020"
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        TransportIconButton {
                                            ...
                                            background: Rectangle {
                                                radius: width / 2
                                                color: inputPreviewPlay.down ? "#4A3208" : "#251F10"
                                ...
                                MouseArea {
                                 ...
                                 ColumnLayout {
                                     ...
                                     Label {
                                         ...
                                         Layout.fillWidth: true
                                         text: qsTr("当前版本仅加载上方列出的受信模型；其他文件不会执行。")
                                         color: page.muted
                                         font.pixelSize: 10
                                         wrapMode: Text.Wrap
                                         maximumLineCount: 3
                ...
                Rectangle {
                    ...
                    RowLayout {
                         ...
                         TransportIconButton {
                             ...
                             background: Rectangle {
                                 radius: width / 2
                                 color: transportPlay.down ? "#07512F" : "#063522"
