    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                ComboBox { objectName: "formatEncoderBox"; Layout.fillWidth: true; Layout.preferredHeight: 34; model: [converter.currentCapability.encoderLabel || "--"] }
                Text { text: qsTr("码率模式"); color: "#aeb9c1" }
                RowLayout {
                    Button {
                        id: cbrButton; text: "CBR"; checkable: true; checked: true
                        Layout.fillWidth: true; Layout.preferredHeight: 34; onClicked: vbrButton.checked = false
                    ...
                    Button {
                        ...
                        Layout.fillWidth: true; Layout.preferredHeight: 34; onClicked: cbrButton.checked = false
                        background: Rectangle { color: parent.checked ? "#0c63c8" : "#0c1821"; border.color: parent.checked ? "#1688ff" : "#263b49"; radius: 5 }
                        contentItem: Text { text: parent.text; color: "#eef3f6"; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter }
                    }
                }
                Text { text: qsTr("目标码率"); color: "#aeb9c1" }
                ComboBox { id: bitRateBox; Layout.fillWidth: true; Layout.preferredHeight: 34; enabled: converter.currentCapability.lossy === true; model: [{text:"128 kbps",value:128000},{text:"192 kbps",value:192000},{text:"256 kbps",value:256000},{text:"320 kbps",value:320000}]; textRole:"text"; valueRole:"value"; currentIndex:3 }
                ...
                ComboBox { id: channelBox; Layout.fillWidth: true; Layout.preferredHeight: 34; model: [{text:qsTr("自动"),value:""},{text:qsTr("单声道"),value:"mono"},{text:qsTr("立体声"),value:"stereo"}]; textRole:"text"; valueRole:"value"; currentIndex:2 }
            ...
            GridLayout {
                ...
                ComboBox { id: conflictBox; Layout.fillWidth: true; Layout.preferredHeight: 34; model: [{text:qsTr("自动序号"),value:"auto-number"},{text:qsTr("跳过"),value:"skip"},{text:qsTr("覆盖"),value:"overwrite"},{text:qsTr("询问"),value:"ask"}]; textRole:"text"; valueRole:"value" }
                CheckBox { id: keepMetadataCheck; objectName: "keepMetadataCheck"; Layout.preferredHeight: 30; text: qsTr("保留元数据"); checked: SettingsController.preserveMetadata; onToggled: SettingsController.preserveMetadata = checked }
                CheckBox { id: keepCoverCheck; Layout.preferredHeight: 30; text: qsTr("保留封面"); checked: true; enabled: converter.currentCapability.supportsCover === true }
                CheckBox { id: preserveDirectoriesCheck; Layout.preferredHeight: 30; text: qsTr("保留目录结构"); checked: true }
                CheckBox { id: extractAudioCheck; objectName: "extractAudioCheck"; Layout.preferredHeight: 30; text: qsTr("从视频中提取音频"); checked: false }
            }
