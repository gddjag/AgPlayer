...
// Adapted from Unlock Music (MIT), Copyright (c) 2019-2023 MengYX.
// See LICENSES/unlock-music.txt.
namespace agplayer {
inline constexpr std::array<std::uint8_t, 16> kKgmHeader{
    0x7C, 0xD5, 0x32, 0xEB, 0x86, 0x02, 0x7F, 0x4B, 0xA8, 0xAF, 0xA6, 0x8E, 0x0F, 0xFF, 0x99, 0x14,
};
inline constexpr std::array<std::uint8_t, 16> kVprHeader{
    0x05, 0x28, 0xBC, 0x96, 0xE9, 0xE4, 0x5A, 0x43, 0x91, 0xAA, 0xBD, 0xD0, 0x7A, 0xF5, 0x36, 0x31,
};
inline constexpr std::array<std::uint8_t, 17> kVprMaskDiff{
    0x25, 0xDF, 0xE8, 0xA6, 0x75, 0x1E, 0x75, 0x0E, 0x2F, 0x80, 0xF3, 0x2D, 0xB8, 0xB6, 0xE3, 0x11,
    0x00,
};
inline constexpr std::array<std::uint8_t, 272> kKgmTable1{
...
inline constexpr std::array<std::uint8_t, 272> kKgmTable2{
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
inline constexpr std::array<std::uint8_t, 272> kKgmPredefinedMask{
